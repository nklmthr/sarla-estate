...
public class WorkAssignment extends BaseEntity {
    ...
    public void copyFromWorkActivity(WorkActivity workActivity) {
        ...
        this.estimatedDurationHours = workActivity.getEstimatedDurationHoursPerDay();
        this.location = workActivity.getTypicalLocation();
        this.resourcesRequired = workActivity.getResourcesRequired();
        this.safetyInstructions = workActivity.getSafetyInstructions();
        this.workShift = workActivity.getWorkShift();
